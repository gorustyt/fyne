...
const (
	...
	Fog                 = gl.Fog
	FogMode             = gl.FogMode
	FogDensity          = gl.FogDensity
	FogHint             = gl.FogHint
	FogDontCare         = gl.FogDontCare
	Exp                 = gl.Exp
	Exp2                = gl.Exp2
	FogStart            = gl.FogStart
	FogEnd              = gl.FogEnd
	FogColor            = gl.FogColor
	...
	LinearMipMapNearest = gl.LinearMipMapNearest
	GlRgba              = gl.GlRgba
	GlUnsigedBytes      = gl.GlUnsigedBytes
